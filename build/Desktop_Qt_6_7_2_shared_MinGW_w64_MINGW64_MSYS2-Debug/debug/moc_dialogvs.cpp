...
struct qt_meta_stringdata_CLASSDialogVSENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDialogVSENDCLASS = QtMocHelpers::stringData(
    "DialogVS",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDialogVSENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DialogVS::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDialogVSENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDialogVSENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDialogVSENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogVS::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDialogVSENDCLASS.stringdata0))
